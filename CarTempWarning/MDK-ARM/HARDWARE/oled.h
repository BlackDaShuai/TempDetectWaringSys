...
#define OLED_RES_Clr()  HAL_GPIO_WritePin(OLEDRES_GPIO_Port,OLEDRES_Pin, GPIO_PIN_RESET)
#define OLED_RES_Set()  HAL_GPIO_WritePin(OLEDRES_GPIO_Port,OLEDRES_Pin, GPIO_PIN_SET)

//****************数据/命令***************

#define OLED_DC_Clr()  HAL_GPIO_WritePin(OLEDDC_GPIO_Port,OLEDDC_Pin, GPIO_PIN_RESET)
#define OLED_DC_Set()  HAL_GPIO_WritePin(OLEDDC_GPIO_Port,OLEDDC_Pin, GPIO_PIN_SET)
